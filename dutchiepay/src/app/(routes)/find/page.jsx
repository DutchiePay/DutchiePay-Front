          ...
          <>
              ...
              <div className="mt-[40px] min-h-[340px]">
                ...
                <form className="flex flex-col gap-[12px]">
                  <div className="flex gap-[8px] items-baseline">
                    ...
                    <p className="ml-[8px] text-sm">-을 제외한 번호를 입력해주세요</p>
                  </div>
                  <input className="user__input" placeholder="휴대폰 번호 (ex : 01012345678)" type="text" />

                  <button type="submit" className="user__button-blue" onClick={() => setIsSuccess(true)}>
                    아이디(이메일) 찾기
                  </button>
                </form>
              </div>
            ...
            {tab === '비밀번호 재설정' && (
              <div className="mt-[40px]">
                <p className="mb-[40px]">
                  가입 시 등록한 <strong>휴대폰 번호</strong>와 <strong>이메일 주소</strong>를 입력하시면
                  <br />
                ...
                <form className="flex flex-col gap-[12px]">
                  ...
                  <input className="user__input" placeholder="이메일 주소" type="email" />
