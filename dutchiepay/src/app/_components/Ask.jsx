    ...
    <>
      <tr className="border-b-2  border-gray-300 text-center ">
        ...
        <td className="w-[500px] px-2 py-[20px] text-start flex items-center gap-[4px]">
          ...
          <p className="product-ask__text flex-1 title--single-line">
            배송이 빠르고 제품 포장도 꼼꼼했습니다. 제품 자체도 튼튼하고 오래 쓸
            것 같아요. 배송이 빠르고 제품 포장도 꼼꼼했습니다. 제품 자체도
            튼튼하고 오래 쓸 것 같아요. 배송이 빠르고 제품 포장도 꼼꼼했습니다.
            제품 자체도 튼튼하고 오래 쓸 것 같아요. 배송이 빠르고 제품 포장도
            꼼꼼했습니다. 제품 자체도 튼튼하고 오래 쓸 것 같아요.
          </p>
        </td>
