...
export default function Product_Main() {
  ...
  return (
    ...
    >
      <Image className="w-full h-[210px] rounded-xl" src={product} alt="애슐리 볶음밥" width={210} height={210} />
      ...
      <div className="flex items-center gap-[4px]">
        <Image className="w-[18px] h-[18px]" src={clock} alt="남은 시간" width={18} height={18} />
        <p className="text-blue--700 text-[12px] font-semibold">12일 08시간 36분 남음</p>
      </div>
    </Link>
  );
}
