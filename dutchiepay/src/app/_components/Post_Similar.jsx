  ...
  return (
    <div>
      <div className="flex items-center gap-[4px]">
        <Image className="w-[16px] h-[16px] rounded-full border" src={profile} alt="프로필" width={16} height={16} />
      ...
      <div className="flex justify-between items-center mt-[4px]">
        ...
        <div className="flex gap-[4px] items-center">
          <Image className="w-[15px] h-[15px]" src={comment} alt="댓글" width={15} height={15} />
