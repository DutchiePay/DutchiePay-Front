      ...
      <div className="w-[240px] px-[12px] pt-[4px] pb-[8px]">
        ...
        <div className="flex flex-col gap-[8px] my-[4px]">
          <div className="flex gap-[8px] items-center">
            <Image className="w-[18px] h-[18px]" src={product} alt="상품" width={18} height={18} />
          ...
          <div className="flex gap-[8px] items-center">
            <Image className="w-[18px] h-[18px]" src={money} alt="가격" width={18} height={18} />
            <p className="text-xs font-medium">{isTrade ? '15,000원' : '나눔'}</p>
          </div>
        </div>
