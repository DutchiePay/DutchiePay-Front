...
export default function Post_Mart() {
  ...
  return (
    <Link href="/mart/123" className="w-[240px] border rounded-xl flex flex-col gap-[4px] cursor-pointer">
      ...
      <div className="w-[240px] px-[12px] pt-[4px] pb-[8px]">
        ...
        <div className="flex flex-col gap-[8px] my-[4px]">
          <div className="flex gap-[8px] items-center">
            <Image className="w-[18px] h-[18px]" src={date} alt="일정" width={18} height={18} />
            <p className="text-xs font-medium">08월 02일 금요일 오후 07시 00분</p>
          </div>
          <div className="flex gap-[8px] items-center">
            <Image className="w-[18px] h-[18px]" src={location} alt="위치" width={18} height={18} />
            <p className="text-xs font-medium">이마트 부천점</p>
          </div>
          <div className="flex gap-[8px] items-center">
            <Image className="w-[18px] h-[18px]" src={people} alt="인원수" width={18} height={18} />
