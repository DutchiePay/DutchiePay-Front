  ...
  return (
    <div className="w-[1020px] m-0 m-auto mt-[12px]">
      ...
      <div className="flex items-center relative w-full">
        <Image className="w-[160px] h-[96px] mr-[65px] " src={logo} alt="logo" width={160} height={96}></Image>
        ...
        <div className="flex justify-end w-full">
          <Image className="w-[50px] h-[50px]" alt="chat" width={40} height={40} src={chat}></Image>
          <Image
            className="w-[50px] h-[50px] rounded-full border ml-[18px]"
            src={profile}
            alt="profile"
            width={55}
            height={55}
