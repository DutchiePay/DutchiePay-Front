...
export default function Floating() {
  ...
  return (
    <div className="fixed w-[50px] h-[50px] right-[50px] bottom-[100px] ">
      <div className="relative rounded-full w-[70px] h-[70px] bg-blue--500 flex items-center justify-center cursor-pointer">
        ...
        {hasNotification && (
          <div className="absolute top-[0px] right-[0px] w-[20px] h-[20px] bg-red--500 rounded-full border-white border-2"></div>
        )}
      </div>
    </div>
  );
